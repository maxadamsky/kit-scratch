...
- [C01] Application code lives under a top-level src directory, one package per deliverable;
  ...
  [source: https://docs.pytest.org/en/stable/explanation/goodpractices.html · tier: 1-docs · read_on: 2023-09-14]
- [C02] Test modules mirror the path of the module they exercise, so a reader can find the tests
  ...
  [source: https://docs.pytest.org/en/stable/explanation/goodpractices.html · tier: 1-docs · read_on: 2026-08-14]
...
- [C04] The repository exists to verify the ai-delivery kit at version 1.7.0, so anything added
  ...
  [source: README.md · tier: 1-code · read_on: 2024-01-23]

## Code Style

- [C05] Classes use CapWords. Acronyms inside a CapWords name are fully capitalized rather than
  title-cased.
  [source: https://peps.python.org/pep-0008/ · tier: 1-docs · read_on: 2026-08-18]
...
- [C07] A single leading underscore marks a non-public method or attribute. Double leading
  ...
  [source: https://peps.python.org/pep-0008/ · tier: 1-docs · read_on: 2023-11-30]
- [C08] Imports are grouped in three blocks separated by blank lines: standard library, then
  ...
  [source: https://peps.python.org/pep-0008/ · tier: 1-docs · read_on: 2026-08-21]
...
- [C10] Formatting and line length are settled by the format gate in gates.md, not by review.
  [source: .ai-delivery/gates.md · tier: 1-code · read_on: 2023-09-14]

## Error Handling & Logging

- [C11] Exception classes end in the word Error.
  [source: https://peps.python.org/pep-0008/ · tier: 1-docs · read_on: 2026-08-25]
...
- [C13] Validation failures are logged and monitored, because a run of them is an attack signal
  ...
  [source: https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html · tier: 1-docs · read_on: 2024-01-23]
- [C14] Log records never carry secrets, credentials, or tokens.
  [source: https://cheatsheetseries.owasp.org/cheatsheets/Secrets_Management_Cheat_Sheet.html · tier: 1-docs · read_on: 2026-08-14]
...
- [C16] pytest is the test framework. Test files match the test underscore prefix or suffix
  ...
  [source: https://docs.pytest.org/en/stable/explanation/goodpractices.html · tier: 1-docs · read_on: 2024-04-08]
- [C17] The importlib import mode is preferred so tests do not mutate the interpreter path and
  ...
  [source: https://docs.pytest.org/en/stable/explanation/goodpractices.html · tier: 1-docs · read_on: 2026-08-18]
...
- [C20] Tests are written before the implementation they cover, and the suite that runs at
  ...
  [source: ai-delivery/skills/setup/profiles/software.md § Test-first meaning · tier: 1-profile · read_on: 2026-08-21]
...
- [C22] A contract consumed across a unit boundary is defined as an interface or protocol rather
  ...
  [source: ai-delivery/skills/setup/profiles/software.md § Spec contents · tier: 1-profile · read_on: 2024-01-23]
- [C23] Every component must be testable with mock dependencies alone — needing a live database,
  ...
  [source: ai-delivery/skills/setup/profiles/software.md § Spec contents · tier: 1-profile · read_on: 2026-08-25]
...
- [C25] Untrusted input is validated on arrival, server-side, before any processing, and as early
  ...
  [source: https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html · tier: 1-docs · read_on: 2024-04-08]
- [C26] Validation is allowlist-based: state what is permitted rather than what is forbidden. A
  ...
  [source: https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html · tier: 1-docs · read_on: 2026-08-14]
...
- [C28] Regular expressions applied to untrusted input anchor the whole value and are built to
  ...
  [source: https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html · tier: 1-docs · read_on: 2023-09-14]
- [C29] Uploaded files are stored under server-generated random names; a client-supplied path or
  filename is never trusted.
  [source: https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html · tier: 1-docs · read_on: 2026-08-18]
...
- [C31] Secret detection runs both before commit and in the pipeline. The secret-detection gate
  ...
  installed here.
  [source: https://cheatsheetseries.owasp.org/cheatsheets/Secrets_Management_Cheat_Sheet.html · tier: 1-docs · read_on: 2024-01-23]
- [C32] Access to secrets follows least privilege, and a compromised secret is revoked
  ...
  [source: https://cheatsheetseries.owasp.org/cheatsheets/Secrets_Management_Cheat_Sheet.html · tier: 1-docs · read_on: 2026-08-21]
...
- [C34] Public functions, classes, and modules carry docstrings stating what the surface does,
  ...
  [source: ai-delivery/skills/setup/profiles/software.md § Verification method · tier: 1-profile · read_on: 2023-11-30]
- [C35] Engineering decisions are recorded in docs/decisions.md at the point the decision is
  ...
  [source: .ai-delivery/config.md § Preferences · tier: 1-code · read_on: 2026-08-25]
...
- [C37] Hierarchy: a Linear project is one feature; milestones are its delivery stages (MVP
  ...
  [source: kit design · tier: 1-docs · read_on: 2023-09-14]
- [C38] Work for this project lives in team CDR (Cdrun-metrics).
  [source: .ai-delivery/config.md § Linear · tier: 1-code · read_on: 2026-08-14]
...
- [C40] Kit-reserved labels are defined by the skills, not by this file, and are never renamed
  ...
  [source: Linear list_issue_labels for team CDR · tier: 1-code · read_on: 2024-01-23]
- [C41] This team's own taxonomy is Feature, Bug, and Improvement. Reuse these rather than
  ...
  [source: Linear list_issue_labels for team CDR · tier: 1-code · read_on: 2026-08-18]
